    ...
    <div class="display__content">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-11">
                <div class="headingTertiary text-light text-uppercase">Closed Orders</div>
                  ...
                  <?php if ($db->num_rows<1): ?>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="display">
                                ...
                                <tr>
                                    <td class="smalll"><a
                                            href="closed-details.php?pid=<?php echo urlencode(convert_uuencode($result->project_id)) ?>"><?php echo $result->project_id; ?><i
