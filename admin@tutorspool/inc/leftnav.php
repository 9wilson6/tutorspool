...
<ul class="list-group">
<a href="index.php"  <?php if ($page=="dashboard") { ?>
class="active"
...
<ul class="list-group">
<a href="stud_activate.php" <?php if ($page=="student_activate") { ?>
class="active" 
<?php } ?> ><li class="list-group-item">Activate <i class="fas fa-toggle-on icon-l"></i></li></a>

<a href="student_suspend.php" <?php if ($page=="student_suspend") { ?>
class="active" 
<?php } ?> ><li class="list-group-item">Suspend <i class="fas fa-power-off icon-l"></i></li></a>

<a href="stud_message.php" <?php if ($page=="stud_message") { ?>
class="active" 
...
<ul class="list-group">
<a href="tut_activate.php" <?php if ($page=="tutor") { ?>
class="active" 
<?php } ?> ><li class="list-group-item">Activate <i class="fas fa-toggle-on icon-l"></i></li></a>

<a href="tutor_suspend.php" <?php if ($page=="tut_suspend") { ?>
class="active" 
<?php } ?> ><li class="list-group-item">Suspend <i class="fas fa-power-off icon-l"></i></li></a>

<a href="tut_message.php" <?php if ($page=="tut_message") { ?>
class="active" 
<?php } ?> ><li class="list-group-item">Message <i class="far fa-comments icon-l"></i></li></a>
...
<ul class="list-group">
<a href="manage_order.php" <?php if ($page=="manage_order") { ?>
class="active" 
...
<a href="../logout.php"> <li class="list-group-item"><i class="fas fa-sign-out-alt icon-r"></i>Logout</li></a>
