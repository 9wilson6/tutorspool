  ...
  <nav class="navbar navbar-expand-lg">
    ...
    <a class="navbar-brand" href="#"
      ><span class="navbar-brand__start"
        ><img src="https://img.icons8.com/dusk/64/000000/text.png" alt="" class="navbar__logo" /><span style="position: relative; top:7px; left: -10px;">UTORSPOOL</span></a
    >
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <a class="nav-link" href="#">Getting started</a>
        ...
        <li class="nav-item dropdown">
          <a
            class="nav-link dropdown-toggle nav-link--excemption"
            href="#"
            id="navbarDropdown"
            role="button"
       ...
       ?><i class="far fa-user-circle icon"></i
          ></a>
          <div
            class="dropdown-menu navbar__toggle"
            aria-labelledby="navbarDropdown"
          >
            <!-- <a class="dropdown-item"  href="#"><i class="fas fa-user icon-r"></i>Profile</a> -->
            <a class="dropdown-item " href="account_details.php"
              ><i class="fas fa-sliders-h icon-r"></i>Update account</a
            >
            <a class="dropdown-item " href="../logout.php"
              ><i class="fas fa-sign-out-alt icon-r"></i>Logout</a
            >
          </div>
        </li>
      </ul>
