    ...
    <div class="row">
              ...
              <div class="dashboard__content mb-5">
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    ...
                    <ul class="list-group">
                      <a href="available.php" class="dashboard__content--items">
                        <li class="list-group-item"> Available <span id="available"></span> </li>
                      </a>
                      <a href="progress.php" class="dashboard__content--items">
                        <li class="list-group-item">Progress<span id="progress"></span></li>
                      </a>
                      <a href="delivered.php" class="dashboard__content--items">
                        <li class="list-group-item">Delivered <span id="delivered"></span></li>
                      </a>
                      <a href="revision.php" class="dashboard__content--items">
                        <li class="list-group-item">Revisions <span id="revision"></span></li>
                      </a>
                      <a href="closed.php" class="dashboard__content--items">
                  ...
                  <div class="col-sm-4">
                    ...
                    <ul class="list-group">
                      <a href="tutors.php" class="dashboard__content--items">
                        <li class="list-group-item">Tutors <span id="tutors"></span></li>
                      </a>
                      <a href="students.php" class="dashboard__content--items">
                        <li class="list-group-item">Students <span id="students"></span></li>
                      </a>

                      <a href="applications.php" class="dashboard__content--items">
                        <li class="list-group-item">Applications <span id="applications"></span></li>
                      </a>
                      <a href="suspended.php" class="dashboard__content--items">
                ...
                <div class="col-sm-4">
                  ...
                  <ul class="list-group">
                    ...
                    <a href="dues.php" class="dashboard__content--items">
                    ...
                    <a href="balance_update.php" class="dashboard__content--items">
      ...
      <div class="col-sm-12 col-md-12 col-lg-12 col-xl-5">
        <div class="card">
          ...
          <!--card body-->
          <div class="card-footer"><a href="notes.php" class="btn btn-info btn-block">VIEW ALL</a></div>
        </div>
        <!--card-->
      </div>
      <!--col2-->
...
<script>
 ...
 $("#available").load('dashboard_counters.php', {
        type: 'available',
        submit: 'submit'
      });
      $("#progress").load('dashboard_counters.php', {
        type: 'progress',
        submit: 'submit'
      });
      // }, 3000);
     // setInterval(function () { 
      ...
      $("#delivered").load('dashboard_counters.php', {
        type: 'delivered',
        submit: 'submit'
      });
      $("#revision").load('dashboard_counters.php', {
        type: 'revision',
        submit: 'submit'
      });

      
      $("#tutors").load('dashboard_counters.php', {
        type: 'tutors',
        submit: 'submit'
      });
     // }, 5000);
     // setInterval(function () {
$("#closed").load('dashboard_counters.php', {
        type: 'closed',
        submit: 'submit'
      });
      $("#students").load('dashboard_counters.php', {
        type: 'students',
        submit: 'submit'
      });
          $("#balance").load('dashboard_counters.php', {
        type: 'balance',
        submit: 'submit'
      });
      $("#dues").load('dashboard_counters.php', {
        type: 'dues',
        submit: 'submit'
      });
      // }, 7000);
    // setInterval(function () {
      ...
      $("#suspended").load('dashboard_counters.php', {
        type: 'suspended',
        submit: 'submit'
      });
      $("#applications").load('dashboard_counters.php', {
        type: 'applications',
        submit: 'submit'
      });
