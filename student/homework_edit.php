...
header("LOCATION:my-homework.php");
}
}
ob_flush();
////////////////////////////////////////////////////////////////////////
...
<h2>Project id <?php echo $homework_id; ?> Edit</h2>
</div>
</div>
</div>
...
<?php endif?>
<form method="POST" action="homework_edit.php">
<!-- /////// -->
...
class="form-control forms2__select" min="0" max=""
