...
<h2>Project id <?php echo $project_id; ?></h2>
</div>
</div>
</div>
...
&rarr;</label></div> -->
<div class="col-12 col-sm-12 col-md-6 py-3"><input type="file"
...
<div class="col-12 col-sm-12 col-md-3 my-4">
    ...
    <button type="submit" name="submit" style="margin: 0 auto" class="btn btn-submit btn-block">Upload Files</button>
...
project</button></div>
<div class="col-md-6 col-sm-12 mb-4"><a href="homework_edit.php?id=<?php echo urlencode(convert_uuencode($project_id)) ?>"
...
<?php
 ...
 ?>
 <a
href="tutor-profile.php?key=<?php echo urlencode(convert_uuencode($result->tutor_id)); ?>">
...
<td>
<form action="assing.php" method="POST" id="assing">
