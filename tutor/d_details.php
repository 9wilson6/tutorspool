...
<h2><?php echo "Project # ".$project_id . " Details"; ?></h2>
</div>
</div>
</div>
...
<th scope="row" class="text-center mt-5" width="100px">
    <a href="student-profile.php?key=<?php echo urlencode(convert_uuencode($results->student_id)); ?>"><?php echo $results->student_id; ?><i class="fas fa-external-link-alt icon-r ml-4"></i></a>
</th>
...
<div class="col-4">
<button class="btn btn-danger btn-block btn-sm" name="delete" style="height: 33px;" 
