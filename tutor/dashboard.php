...
<tr>
<td class="smalll"><a
href="d_details.php?id=<?php echo urlencode(convert_uuencode($result->project_id)); ?>"><?php echo $result->project_id; ?><i
class="fas fa-external-link-alt icon-r ml-4"></i></a></td>
<td class="wide">
	<a
href="d_details.php?id=<?php echo urlencode(convert_uuencode($result->project_id)); ?>"><?php echo (strlen($result->title) >35 )? substr($result->title, 0, 35).'...':$result->title; ?>
</a>
</td>
...
<td class="smalll">
<a
href="d_details.php?id=<?php echo urlencode(convert_uuencode($result->project_id)); ?>"><?php echo $result->subject;?>
</a></td>
