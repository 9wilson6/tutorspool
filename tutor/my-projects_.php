...
<table class="table table-bordered">
  <thead>
    <tr>
      ...
      <th data-toggle="tooltip" title="Price $" data-placement="right">
        Price($)
      </th>
  ...
  <tbody>
    ...
    <tr>
      <td class="smalll">
        <a
          href="my-projects-details.php?id=<?php echo urlencode(convert_uuencode($result->project_id)); ?>"
      ...
      <td class="wide">
        <?php echo (strlen($result->title) >35 )? substr($result->title, 0,
        35).'...':$result->title; ?>
      </td>
      ...
      <td>
        <?php $time=getDateTimeDiff($date_global, $result->deadline ); $period=
        explode(" ", $time); ?>
