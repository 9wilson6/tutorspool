...
<td>
<a href="in-progress-details.php?pid=<?php echo urlencode(convert_uuencode($result->project_id)) ?>#messageBox" class="btn btn-sm btn-block" style="background: #00897b; color:white;">view</a>
</td>
<?php elseif ($result->status == 2): ?>
<td>
<a href="delivered-details.php?pid=<?php echo urlencode(convert_uuencode($result->project_id)) ?>#messageBox" class="btn btn-sm btn-block" style="background: #00897b; color:white;">view</a>
</td>
<?php elseif ($result->status == 3): ?>
<td>
<a href="revision-details.php?pid=<?php echo urlencode(convert_uuencode($result->project_id)) ?>#messageBox" class="btn btn-sm btn-block" style="background: #00897b; color:white;">view</a>
</td>
<?php elseif ($result->status > 3): ?>
<td>
<a href="my-projects-details.php?pid=<?php echo urlencode(convert_uuencode($result->project_id)) ?>#messageBox" class="btn btn-sm btn-block" style="background: #00897b; color:white;">view</a>
</td>
<?php endif?>
</tr>
<?php else: ?>
